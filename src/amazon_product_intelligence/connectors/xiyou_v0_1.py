...
XIYOU_OPERATIONS = (
    _operation("asin_info", "asin_info", "get_asin_info", "/v1/asins/info"),
    _operation(
        "asin_variations",
        "asin_variations",
        "get_asin_variations",
...
XIYOU_CAPABILITIES = (
    _capability(
        ...
        source_field="data.entities[].asin",
        operation="asin_info",
    ...
    _capability(
        ...
        source_field="data.entities[].country / request country",
        operation="asin_info",
        payload_kind="asin_info",
    ...
    _capability(
        "product.title",
        CapabilityStatus.AVAILABLE,
        source_field="data.entities[].title",
        operation="asin_info",
        payload_kind="asin_info",
    ...
    _capability(
        "metric.price",
        CapabilityStatus.AVAILABLE,
        source_field="data.entities[].price",
        operation="asin_info",
        payload_kind="asin_info",
    ...
    _capability(
        "metric.rating",
        CapabilityStatus.AVAILABLE,
        source_field="data.entities[].stars",
        operation="asin_info",
        payload_kind="asin_info",
        kind=ObservationKind.METRIC,
        names=("rating",),
    ...
    _capability(
        "metric.review_count",
        CapabilityStatus.AVAILABLE,
        source_field="data.entities[].ratings",
        operation="asin_info",
        payload_kind="asin_info",
        kind=ObservationKind.METRIC,
        names=("review_count",),
    ...
    _capability(
        ...
        CapabilityStatus.AVAILABLE,
        source_field="data.list[].abaReport.weeklySearchVolume",
        operation="keyword_info",
        payload_kind="keyword_info",
    ...
    _capability(
        "keyword.aba_rank",
        CapabilityStatus.AVAILABLE,
        source_field="data.list[].abaReport.searchFrequencyRank",
        operation="keyword_info",
        payload_kind="keyword_info",
        kind=ObservationKind.KEYWORD_METRIC,
    ...
    _capability(
        "keyword.cpc",
        CapabilityStatus.AVAILABLE,
        source_field="data.list[].costPerClick.value",
        operation="keyword_info",
        payload_kind="keyword_info",
        kind=ObservationKind.KEYWORD_METRIC,
        names=("cpc",),
    ...
    _capability(
        "keyword.difficulty",
        CapabilityStatus.AVAILABLE,
        source_field="data.list[].competitiveDifficulty",
        operation="keyword_info",
        payload_kind="keyword_info",
        kind=ObservationKind.KEYWORD_METRIC,
    ...
    _capability(
        ...
        CapabilityStatus.AVAILABLE,
        source_field="data.list[] / data.list[].ranks[]",
    ...
    _capability(
        "keyword.channel",
        CapabilityStatus.PARTIAL,
        source_field="data.list[].ranks[].position",
        operation="keyword_asin_analysis",
        payload_kind="keyword_asin_analysis",
        kind=ObservationKind.PRODUCT_KEYWORD_RELATIONSHIP,

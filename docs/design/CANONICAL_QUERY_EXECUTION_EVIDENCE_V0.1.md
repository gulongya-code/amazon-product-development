...
Provider adapter ruleset `provider-adapters-v0.1.2` and XiYou adapter version `0.1.2` publish directional execution evidence for both audited query mappings:
...
- Only audited XiYou directional query payloads emit this record in V0.1.2.

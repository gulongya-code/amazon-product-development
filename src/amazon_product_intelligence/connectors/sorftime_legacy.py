"""Historical Sorftime fixture adapter; never an ordinary-HTTP production path."""
...
class LegacySorftimeFixtureProvider(AdapterBackedProvider):
    """Historical fixture-only adapter with non-HTTP logical operations."""
    ...
    def __init__(
        ...
        *,
        ...
        if fixture_only is not True:
            raise ValueError("legacy Sorftime adapter is restricted to explicit offline fixtures")
        super().__init__(
            provider_id="sorftime",
...
__all__ = ("LegacySorftimeFixtureProvider",)
